...
class Book {
    constuctor(title, author, copyright, isbn, pageCount, timesCheckedOut, discarded){
        this.title = title;
        this.author = author;
...
let shuttleBuidlingManual = new Manual("Top Secret Shuttle Building Manual", "Redacted", 2013, '0000000000000', 1147, 1, "No");
...
shuttleBuidlingManual.dispose(2023);
